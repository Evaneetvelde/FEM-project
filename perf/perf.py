...
BENCHMARK_MESHES = [
	MeshSpec("2d_peu_noeuds", "2D peu de noeuds", 2, PROJECT_ROOT / "models" / "perf" / "bench_2d_peu_noeuds.msh", "peu"),
	MeshSpec("2d_moyen_noeuds", "2D moyennement de noeuds", 2, PROJECT_ROOT / "models" / "perf" / "bench_2d_moyen_noeuds.msh", "moyen"),
	MeshSpec("2d_beaucoup_noeuds", "2D beaucoup de noeuds", 2, PROJECT_ROOT / "models" / "perf" / "bench_2d_beaucoup_noeuds.msh", "beaucoup"),
	MeshSpec("2d_pathologique", "2D pathologique", 2, PROJECT_ROOT / "models" / "perf" / "bench_2d_pathologique.msh", "pathologique"),
	MeshSpec("3d_peu_noeuds", "3D peu de noeuds", 3, PROJECT_ROOT / "models" / "perf" / "bench_3d_peu_noeuds.msh", "peu"),
	MeshSpec("3d_moyen_noeuds", "3D moyennement de noeuds", 3, PROJECT_ROOT / "models" / "perf" / "bench_3d_moyen_noeuds.msh", "moyen"),
	MeshSpec("3d_beaucoup_noeuds", "3D beaucoup de noeuds", 3, PROJECT_ROOT / "models" / "perf" / "bench_3d_beaucoup_noeuds.msh", "beaucoup"),
	MeshSpec("3d_pathologique", "3D pathologique", 3, PROJECT_ROOT / "models" / "perf" / "bench_3d_pathologique.msh", "pathologique"),
]
...
def build_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument("--steps", type=int, default=20, help="Nombre de steps par run.")
